function [time,x,y,t,xEst,yEst,tEst,xVar,yVar,xyVar] = SimKSLimportfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   [TIME,X,Y,T,XEST,YEST,TEST,XVAR,YVAR,XYVAR] = IMPORTFILE(FILENAME)
...
%
% Example:
%   [time,x,y,t,xEst,yEst,tEst,xVar,yVar,xyVar] = importfile('Sim_KSL10.txt',1, 10402);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2016/04/01 01:34:47
